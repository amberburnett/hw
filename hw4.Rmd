...
ggplot(sep.spurs,aes(,x=stats.FG.,y=player,color=position)) + geom_bar(stat="identity") + xlab("Player Names") + ylab("Field Goal Percentage") + ggtitle("The Spurs Players' Field Goal Percentages")
```
